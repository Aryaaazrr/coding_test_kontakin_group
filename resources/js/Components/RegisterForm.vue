                    ...
                    <div class="grid gap-6">
                        ...
                        <div class="grid gap-6">
                            <div class="grid gap-2">
                                <Label html-for="username" value="username"
                                    >Username</Label
                                >
                                <Input
                                    id="username"
                            ...
                            <div class="grid gap-2">
                                <Label html-for="email" value="email"
                                    >Email</Label
                                >
                                <Input
                                    id="email"
                            ...
                            <div class="grid gap-2">
                                <div class="flex items-center">
                                    <Label html-for="password" value="password">Password</Label>
                                </div>
                            ...
                            <div class="grid gap-2">
                                <div class="flex items-center">
                                    <Label html-for="password_confirmation" value="password_confirmation">Confirm Password</Label>
                                </div>
